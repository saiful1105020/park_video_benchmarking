...
wandb_results_path = f"/localdisk1/{project_dir}/{project_name}/results/R3_Screening_Performance_with_SMOTE/wandb_results/wandb_runs_summary_multi_view_top_100.csv"
summary_results_path = f"/localdisk1/{project_dir}/{project_name}/results/R3_Screening_Performance_with_SMOTE/wandb_results/summary_best_models_per_task_with_random_seeds_multi_view.csv"
latex_path = f"/localdisk1/{project_dir}/{project_name}/results/R3_Screening_Performance_with_SMOTE/latex/summary_best_models_per_task_with_random_seeds_final_with_CI_random_seeds_multi_view.tex"
...
def summarize_wandb_results(wandb_results_path):
    ...
    for task in task_names:
        ...
        for seed in random_seeds:
            params["seed"] = seed
            python_command = f"python /localdisk1/{project_dir}/{project_name}/code/R3_Screening_Performance_with_SMOTE/train_multi_view_with_smote_for_final_results.py"
        ...
        results_df.to_csv(f"/localdisk1/{project_dir}/{project_name}/results/R3_Screening_Performance_with_SMOTE/wandb_results/detailed_results_multi_view_{task}_model_{best_model}.csv", index=False)
...
if __name__ == "__main__":
    ...
    for task in summary_df["Task"]:
        ...
        task_result_path = f"/localdisk1/{project_dir}/{project_name}/results/R3_Screening_Performance_with_SMOTE/wandb_results/detailed_results_multi_view_{task_str}_model_{model_name_from_display[model]}.csv"
